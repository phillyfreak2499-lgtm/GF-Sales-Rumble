...
const LOCKER_TABS = [
  ...
  },
  {
    label: "Stats",
    icon: Trophy,
    blurb: "Record, period points, heat, and this week’s four floor jobs. Check a job off for stars on the belt.",
  },
  {
    label: "Card",
    icon: ClipboardList,
        ...
        <div className="mt-6 grid gap-3 lg:grid-cols-2">
          ...
          <RingCard>
            ...
            <ul className="mt-4 space-y-3 text-sm leading-relaxed text-muted">
              ...
              <li>
                <span className="text-fg">Stars.</span> Four random floor jobs. Check them off. Spend them on Belt.
              </li>
            </ul>
          </RingCard>
        </div>
      ...
      <section id="locker" className="mt-16 scroll-mt-28">
        ...
        <RingCard className="mt-3 p-5 sm:p-7">
          ...
          <ol className="mt-4 space-y-3 text-sm leading-relaxed text-muted">
            ...
            <li>
              <span className="text-fg">3. Stats.</span> Check off the four floor jobs. Stars hit the belt.
            </li>
            <li>
