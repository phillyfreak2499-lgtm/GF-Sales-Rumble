...
export const BELT_SHOP: BeltItem[] = [
  ...
  { id: "border-sage", slot: "border", name: "Green ring", blurb: "Looks like a sweep.", cost: 8, swatch: "sage", tier: "bright" },
  { id: "border-steel", slot: "border", name: "Steel cable", blurb: "Cool. Clean. Blue.", cost: 8, swatch: "steel", tier: "bright" },
  { id: "border-amber", slot: "border", name: "Heat rope", blurb: "Warm edge. Crowd notice.", cost: 10, swatch: "amber", tier: "bright" },
  { id: "border-rose", slot: "border", name: "Upset red", blurb: "You came from a loss.", cost: 10, swatch: "rose", tier: "bright" },
  { id: "border-double", slot: "border", name: "Double rope", blurb: "Two rings. Title energy.", cost: 14, swatch: "double", tier: "bright" },
  { id: "border-neon-cyan", slot: "border", name: "Ice neon", blurb: "Glows. The aisle sees you first.", cost: 25, swatch: "neon-cyan", tier: "neon" },
  { id: "border-neon-pink", slot: "border", name: "Hot neon", blurb: "Pink voltage. Cannot miss it.", cost: 25, swatch: "neon-pink", tier: "neon" },
  { id: "border-neon-lime", slot: "border", name: "Lime wire", blurb: "Electric green. Night-card energy.", cost: 28, swatch: "neon-lime", tier: "neon" },
  { id: "border-gold", slot: "border", name: "Gold rope", blurb: "Heavy. Expensive. Week 4 talk.", cost: 40, swatch: "gold", tier: "gold" },
  { id: "border-gold-double", slot: "border", name: "Gold double", blurb: "Two gold rings. Championship plate.", cost: 50, swatch: "gold-double", tier: "legend" },

  { id: "bg-surface", slot: "bg", name: "Locker slate", blurb: "The house background.", cost: 0, swatch: "surface", tier: "house" },
  { id: "bg-raised", slot: "bg", name: "Raised card", blurb: "A little more light on the name.", cost: 5, swatch: "raised", tier: "house" },
  { id: "bg-sage", slot: "bg", name: "Green wash", blurb: "Soft sage behind the plate.", cost: 10, swatch: "sage", tier: "bright" },
  { id: "bg-steel", slot: "bg", name: "Blue wash", blurb: "Steel tint. Calm heat.", cost: 10, swatch: "steel", tier: "bright" },
  { id: "bg-amber", slot: "bg", name: "Warm wash", blurb: "Amber behind the letters.", cost: 12, swatch: "amber", tier: "bright" },
  { id: "bg-rose", slot: "bg", name: "Heat wash", blurb: "A little rose in the card.", cost: 12, swatch: "rose", tier: "bright" },
  { id: "bg-neon-cyan", slot: "bg", name: "Cyan flood", blurb: "The plate lights up from inside.", cost: 25, swatch: "neon-cyan", tier: "neon" },
  { id: "bg-neon-pink", slot: "bg", name: "Pink flood", blurb: "Hot wash. Main-event lighting.", cost: 25, swatch: "neon-pink", tier: "neon" },
  { id: "bg-neon-lime", slot: "bg", name: "Lime flood", blurb: "Looks illegal. Still work-ok.", cost: 28, swatch: "neon-lime", tier: "neon" },
  { id: "bg-gold", slot: "bg", name: "Gold wash", blurb: "Warm metal behind the name.", cost: 40, swatch: "gold", tier: "gold" },
  { id: "bg-gold-foil", slot: "bg", name: "Gold foil", blurb: "The plate moves. Save for week 4.", cost: 50, swatch: "gold-foil", tier: "legend" },

  { id: "mark-none", slot: "mark", name: "No mark", blurb: "Just the name.", cost: 0, swatch: "none", mark: "", tier: "house" },
  { id: "mark-star", slot: "mark", name: "Star", blurb: "A star by the plate.", cost: 5, swatch: "amber", mark: "star", tier: "house" },
  { id: "mark-bolt", slot: "mark", name: "Bolt", blurb: "Fast closer.", cost: 8, swatch: "amber", mark: "bolt", tier: "bright" },
  { id: "mark-heat", slot: "mark", name: "Heat", blurb: "The card is hot.", cost: 8, swatch: "rose", mark: "heat", tier: "bright" },
  { id: "mark-crown", slot: "mark", name: "Crown", blurb: "Title picture.", cost: 12, swatch: "amber", mark: "crown", tier: "bright" },
  { id: "mark-live", slot: "mark", name: "Live tag", blurb: "Tiny neon LIVE next to the name.", cost: 20, swatch: "neon-pink", mark: "live", tier: "neon" },
  { id: "mark-foil", slot: "mark", name: "Gold star", blurb: "A gold mark. Quiet flex.", cost: 25, swatch: "gold", mark: "foil", tier: "gold" },

  { id: "sticker-none", slot: "sticker", name: "No sticker", blurb: "Clean plate.", cost: 0, swatch: "", sticker: "", tier: "house" },
  { id: "sticker-closer", slot: "sticker", name: "Closer stamp", blurb: "Medium stamp. You finish tickets.", cost: 20, swatch: "closer", sticker: "closer", tier: "bright" },
  { id: "sticker-heat", slot: "sticker", name: "Heat stamp", blurb: "Medium. The locker is loud.", cost: 20, swatch: "heat", sticker: "heat", tier: "bright" },
  { id: "sticker-sweep", slot: "sticker", name: "Sweep banner", blurb: "Bigger. All green energy.", cost: 25, swatch: "sweep", sticker: "sweep", tier: "neon" },
  { id: "sticker-neon-live", slot: "sticker", name: "Neon LIVE", blurb: "Big neon plate. Week 3 look.", cost: 30, swatch: "neon-live", sticker: "neon-live", tier: "neon" },
  { id: "sticker-gold-seal", slot: "sticker", name: "Gold seal", blurb: "Big wax seal. Costs real work.", cost: 40, swatch: "gold-seal", sticker: "gold-seal", tier: "gold" },
  { id: "sticker-belt", slot: "sticker", name: "Belt buckle", blurb: "Huge. Looks like a title.", cost: 50, swatch: "belt", sticker: "belt", tier: "legend" },
  { id: "sticker-undisputed", slot: "sticker", name: "Undisputed", blurb: "The biggest stamp. Week 4 only if you grind.", cost: 60, swatch: "undisputed", sticker: "undisputed", tier: "legend" },
