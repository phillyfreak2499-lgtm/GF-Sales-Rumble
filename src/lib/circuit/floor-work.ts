...
/** Five jobs, all completable. Always mixed: one sales, one house, one team, plus wild cards. */
export function pickWeekTasks(fighterId: string, week: number, extras: FloorTaskDef[] = [], count = 5): FloorTaskDef[] {
